...
document.addEventListener("DOMContentLoaded", (() => {
    ...
    carouselPrev && carouselNext && (
      ...
      "(min-width: 768px)": function() {
        ...
        document.querySelector(".hero-text-container") && gsap.to(".hero-text-container", {
          yPercent: -15,
          ease: "none",
          scrollTrigger: {
            trigger: ".hero",
        ...
        })), document.querySelector(".big-card .text-content") && gsap.to(".big-card .text-content", {
          yPercent: -20,
          ease: "none",
          scrollTrigger: {
            trigger: ".big-card",
        ...
        }), document.querySelector(".big-card .image-side img") && gsap.to(".big-card .image-side img", {
          yPercent: 20,
          ease: "none",
          scrollTrigger: {
            trigger: ".big-card",
        ...
        }), document.querySelector(".big-card .image-side img") && gsap.fromTo(".big-card .image-side img", {
          scale: 1
        }, {
          scale: 1.1,
          ease: "none",
        ...
        }), document.querySelector(".about-wrapper") && gsap.to(".about-wrapper", {
          yPercent: -10,
          ease: "none",
          scrollTrigger: {
        ...
        }), document.querySelector(".about-image img") && gsap.fromTo(".about-image img", {
          scale: 1
        }, {
          scale: 1.1,
          ease: "none",
    ...
    })), document.querySelector("footer") && gsap.set("footer", {
      autoAlpha: 0,
      y: 40
    }), document.querySelector("footer") && ScrollTrigger.create({
      trigger: "footer",
      start: "top 90%",
      onEnter: () => {
